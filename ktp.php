...
<form method="get" >
  ...
  <input type="text" name="crno_ktp" value="<? echo $crno_ktp?>" id="crno_ktp"  placeholder="Cari No KTP"/>
...
" border="1" id="customers">
  ...
  include("koneksi.php");
  if ($ha==''){
  $tampil=mysql_query("select * from tabel_ktp");
  } else{
  $tampil=mysql_query("select * from tabel_ktp where pengajuan='$un'");}
  while($data=mysql_fetch_array ($tampil)) {
	?>
  <tr>
    <td><a onClick="return confirm('Yakin?')" href="hapus_ktp.php?no_ktp=<?php echo $data['no_ktp']?>" ><img src="img/dlt.png" width="35" height="35"> </a>
    <a href="?hal=edit_ktp&no_ktp=<?php echo $data['no_ktp']?>"><img src="img/edt.png" width="35" height="35"> </a> <a onClick="return confirm('Yakin?')" href="konfir_ktp.php?no_ktp=<?php echo $data['no_ktp']?>" ><img src="img/centang.png" width="35" height="35"> </a> <a onClick="return confirm('Yakin?')" href="konf_lak_ktp.php?no_ktp=<?php echo $data['no_ktp']?>" ><img src="img/silang.jfif" width="35" height="35"> </a>
	<a href="cetak_ktp.php?no_ktp=<?php echo $data['no_ktp']?>" > Cetak</a></td>
	...
	<td><a href="pengantar/<?php echo $data ['fc_sc_kk'] ?>" target="_blank"> <img src="pengantar/<?php echo $data ['fc_sc_kk'] ?>" width="100" height="100"></a></td>
  </tr>
  <?php
  }
  ?>
...
<table width="100%" border="0">
    ...
    <td width="85%"><label for="no_ktp"></label>
