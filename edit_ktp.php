...
<?php
include("koneksi.php");
$cari=mysql_query("select * from tabel_ktp where no_ktp='$no_ktp'");
...
<tr>
    ...
    <td width="85%"><label for="no_ktp"></label>
      <input value="<?php echo $data ['no_ktp']?>" type="text" name="no_ktp" id="no_ktp"  readonly="readonly"/></td>
  </tr>
  <tr>
    <td width="15%">Nik</td>
 ...
 <td>Jenis Kelamin</td>
  ...
  <tr>
    ...
    <td><label for="fc_sc_kk"></label>
      <input value="<?php echo $data['fc_sc_kk']?>" type="file" name="fc_sc_kk" id="fc_sc_kk" /></td>
  </tr>
    <td>&nbsp;</td>
