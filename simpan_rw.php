...
mysql_query("insert into pengantar_rw values ('$no_regis','$un','$nama','$tempat_lahir','$tgl_lahir','$jenis_kelamin','$pekerjaan','$agama','$status_perkawinan','$kewarganegaraan','$alamat')");
