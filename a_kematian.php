...
" border="1" id="customers">
 ...
 <?php
  include("koneksi.php");
  if ($ha==''){
  $tampil=mysql_query("select * from akta_kematian");
  } else{
  $tampil=mysql_query("select * from akta_kematian where pengajuan='$un'");}
  ...
  <tr>
    ...
    <a href="?hal=editak&no_mati=<?php echo $data['no_mati']?>"><img src="img/edt.png" width="35" height="35"> </a> <a onClick="return confirm('Yakin?')" href="konfir_aka.php?no_mati=<?php echo $data['no_mati']?>" ><img src="img/centang.png" width="35" height="35"> </a> <a onClick="return confirm('Yakin?')" href="konf_lak_aka.php?no_mati=<?php echo $data['no_mati']?>" ><img src="img/silang.jfif" width="35" height="35"> </a>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td><label for="tgl_lah_pel"></label>
      <input type="date" name="tgl_lah_pel" id="tgl_lah_pel" /></td>
  </tr>
    <tr>
    <td><p>Umur</p></td>
...
<option value="<? echo $data['id_admin'] ?>"><? echo $data['id_admin'] ?></option>
  ...
  <select type="text" name="rw" id="rw" /></td>
  <tr>
    <td>&nbsp;</td>
